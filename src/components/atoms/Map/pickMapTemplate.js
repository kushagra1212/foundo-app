export const webViewTemplateSelect = ({ latitude, longitude }) => {
  return `
<div>
    ...
    <script>
        ...
        var marker = new tt.Marker({fillColor: 'red', color: 'red', width: 50, height: 70,elevation: 10,draggable: true})
.setLngLat( [${longitude}, ${latitude}])
.addTo(map);
        marker.on('dragend', function() {
            let center = marker.getLngLat();
